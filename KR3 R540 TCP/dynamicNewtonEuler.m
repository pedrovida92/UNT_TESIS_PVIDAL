% Implementación del algoritmo computacional de Newton-Euler para el
% modelado dinámico dinámico del robot

clc, clear

% Entradas
q = [0,0,0,0,0,0];      % Posición articular
qp = [0,0,0,0,0,0];     % Velocidad articular
qpp = [0,0,0,0,0,0];    % Aceleración articular
f0 = [0,0,-1];          % Fuerza desde el Sistema Base
mu0 = [0,0,0];          % Momento desde el Sistema Base
