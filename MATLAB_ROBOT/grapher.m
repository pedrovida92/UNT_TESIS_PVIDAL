...
legend('color','none','Location','northeast')
...
hold on
grid on
plot(T(:,1),T(:,2),'LineWidth',LW)
plot(T(:,1),T(:,3),'LineWidth',LW)
plot(T(:,1),T(:,4),'LineWidth',LW)
plot(T(:,1),T(:,5),'LineWidth',LW)
plot(T(:,1),T(:,6),'LineWidth',LW)
plot(T(:,1),T(:,7),'LineWidth',LW)
legend('$\tau_1$','$\tau_2$','$\tau_3$','$\tau_4$','$\tau_5$','$\tau_6$','Interpreter','latex')
legend('color','none','Location','northeast')
legend('FontSize',font_size)
ylabel('torque [$Nm$]','Interpreter','latex','FontSize',font_size)
xlabel('tiempo [$s$]','Interpreter','latex','FontSize',font_size)
